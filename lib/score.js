...
module.exports = function getScores(data, video) {
  ...
  .reduce((acc,item) => {
    ...
    // { 0: {0: 1000/100, 1: 1000/300}, 2: 1000/200}} ===> savings from endpoint 0 (no requested from endpoint 1)
    // other {1: {4: 2000/50, 2: 2000/600, 1: 2000/100} ===> savings from endpoint 1 (no requested from enpoint 0)
    return acc;
  }, {});
};
